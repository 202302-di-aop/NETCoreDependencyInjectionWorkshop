...
public class TennisBoxTests
{
    ...
    public void SetUp()
    {
        _tennisBox = new TennisBox("Matt", "Joey");
    }
    ...
    [Test]
    public void deuce_state_to_adv_state_when_first_player_adv()
    {
    ...
    [Test]
    public void deuce_state_to_adv_state_when_second_player_adv()
    {
        GivenScoreContext(3, 3);
        WhenSecondPlayerGoal();
    ...
    [Test]
    public void adv_state_to_deuce_state()
    {
        GivenDeuce();
        WhenSecondPlayerGoal();
        WhenFirstPlayerGoal();
    ...
    [Test]
    public void adv_state_to_win_state()
    {
        GivenDeuce();
        WhenSecondPlayerGoal();
        WhenSecondPlayerGoal();
